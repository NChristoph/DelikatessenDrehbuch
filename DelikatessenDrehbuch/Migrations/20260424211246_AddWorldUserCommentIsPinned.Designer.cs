...
namespace DelikatessenDrehbuch.Migrations
{
    ...
    [Migration("20260424211246_AddWorldUserCommentIsPinned")]
    partial class AddWorldUserCommentIsPinned
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DelikatessenDrehbuch.Areas.WorldMiniApp.Models.RecipeAiVariantJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BaseRecipeId", "UpdatedAtUtc");

                    b.ToTable("RecipeAiVariantJobs", (string)null);
                });
            ...
            modelBuilder.Entity("DelikatessenDrehbuch.Areas.WorldMiniApp.Models.WorldUserComment", b =>
                {
                    ...
                    b.HasIndex("UserHash", "CreatedAtUtc");

                    b.HasIndex("WorldUserPostingId", "CreatedAtUtc");

                    b.ToTable("WorldUserComments", (string)null);
                });

            modelBuilder.Entity("DelikatessenDrehbuch.Areas.WorldMiniApp.Models.WorldUserCommentReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("WorldUserCommentId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("WorldUserCommentId", "IsLike");

                    b.HasIndex("WorldUserCommentId", "UserHash")
                        .IsUnique();

                    b.ToTable("WorldUserCommentReactions", (string)null);
                });

            modelBuilder.Entity("DelikatessenDrehbuch.Areas.WorldMiniApp.Models.WorldUserCommentReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WorldUserCommentReports", (string)null);
                });
            ...
            modelBuilder.Entity("DelikatessenDrehbuch.Areas.WorldMiniApp.Models.WorldUserNotification", b =>
                {
                    ...
                    b.HasIndex("UserHash", "IsSeen", "CreatedAtUtc");

                    b.ToTable("WorldUserNotifications", (string)null);
                });
