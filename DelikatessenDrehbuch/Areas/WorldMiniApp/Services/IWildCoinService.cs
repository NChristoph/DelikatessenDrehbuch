...
namespace DelikatessenDrehbuch.Areas.WorldMiniApp.Services
{
    public interface IWildCoinService
    {
        ...
        Task<MealPlanPurchase?> FinalizeWorldChainPurchase(string buyerHash, int listingId, string txHash, string walletAddress, bool allowSelfPurchase = false, string paymentToken = "WLD", string clientAction = "");
