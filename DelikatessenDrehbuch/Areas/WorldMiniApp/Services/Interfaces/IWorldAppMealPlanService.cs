...
namespace DelikatessenDrehbuch.Areas.WorldMiniApp.Services.Interfaces
{
    public interface IWorldAppMealPlanService
    {
        ...
        public Task CheckVerifyAsync(MiniAppSetupModel settings, string userHash, string title);
        public Task SaveNewMealPlanAsync(string userHash, List<MealPlanerModel> mealPlanerModels,string title);
        ...
        public Task<List<WorldUserMealPlan>> GetMealPlansByHashAsync(string userHash);
    }
}
