...
namespace DelikatessenDrehbuch.Areas.WorldMiniApp.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> GetShoppingListText([FromQuery] List<int> recipeIds, int personCount = 1)
        {
            ...
            var aggregated = new List<(string GroupName, string IngredientName, string Unit, decimal Quantity)>();
            ...
            foreach (var recipe in recipes)
            {
                ...
                foreach (var entry in recipe.Ingredients)
                {
                    ...
                    aggregated.Add((groupName, name, unit, quantity * scale));
                }
            }

            var finalGrouped = aggregated
